 ...
 * @author Ephraim
 */
public class InboxMessages extends javax.swing.JFrame {
     ...
     * @param hm_uid
     */
    public InboxMessages(String hm_fn, String hm_uid) {
        initComponents();
        this.hm_uid = hm_uid;
        this.hm_fn = hm_fn;
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(jLabel4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 791, Short.MAX_VALUE)
        );
    ...
    private int countInbox() {
        try {
            ...
            String query = "SELECT count(*) as 'total' FROM " + msg_tbl + " WHERE reciever=?";
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            Connection conn = connDB.getConnection();
            String msg_tbl = connDB.MESSAGES_TABLE;
            String query = "SELECT * FROM " + msg_tbl + " WHERE reciever=?";
            PreparedStatement ps = conn.prepareStatement(query);
            ps.setString(1, hm_uid);
            ResultSet rs = ps.executeQuery();
            ...
            while (rs.next()) {
                ...
                String formated_result = sender + " : " + send_date;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InboxMessages.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InboxMessages(args[1], args[0]).setVisible(true);
            }
        });
    }
